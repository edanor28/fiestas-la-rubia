  ...
  return (
    <nav className="fixed top-0 left-0 w-full z-50 px-4 py-3 sm:px-6 sm:py-4">
      <div className="max-w-7xl mx-auto bg-[#0F172A]/70 backdrop-blur-md border border-white/10 rounded-2xl p-3 flex items-center justify-between shadow-lg">
        ...
        <button className="flex items-center gap-2 bg-white/10 hover:bg-white/20 active:bg-white/10 transition-all text-white text-xs sm:text-sm font-semibold px-4 py-2.5 rounded-xl border border-white/5">
